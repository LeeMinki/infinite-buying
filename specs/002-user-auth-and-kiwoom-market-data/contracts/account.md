...
Fetch account deposit/orderable cash values for the signed-in user's production Kiwoom credential.

**Responses**:

| Status | Body | When |
|---|---|---|
| `200 OK` | `{ "deposit": 5000000, "availableOrderAmount": 4500000, "source": "KIWOOM", "fetchedAt": "2026-04-29T05:12:33.000Z" }` | Kiwoom account lookup succeeded |
