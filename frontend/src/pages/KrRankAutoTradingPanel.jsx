      ...
      <section className="panel section">
        <div className="panel-heading">
          <div>
            ...
            <p>오전 9시 10분(선택 시 11시 30분 점심)에 한국주식 등락률 상위 랭킹을 조회해, 등락률 30% 미만 종목 중 1위를 진입 금액 한도 안에서 매수하고 목표 수익·손절로 청산합니다. 서버가 1분 간격으로 평가합니다.</p>
          </div>
        </div>
        <ul className="kr-rank-rule-list">
          ...
          <li>등락률 30% 이상 종목은 매수 대상에서 제외합니다.</li>
