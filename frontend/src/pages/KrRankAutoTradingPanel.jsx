      ...
      <section className="panel section">
        <div className="panel-heading">
          <div>
            ...
            <p>오전 9시부터 10분간, 점심 진입을 켜면 11시 20분부터 10분간 한국주식 등락률 상위 랭킹을 반복 관찰한 뒤 9시 10분·11시 30분에 종합 후보를 고릅니다. 상승률이 오전 21%·점심 16% 미만이고 거래대금·단기 흐름이 충분한 종목만 현재가 근처 지정가로 매수합니다.</p>
          </div>
        </div>
        <ul className="kr-rank-rule-list">
          ...
          <li>오전은 등락률 21% 이상, 점심은 되돌림 위험을 줄이기 위해 16% 이상 종목을 제외합니다. 우선주와 ETF·ETN·스팩·리츠·레버리지·인버스형 상품도 매수 대상에서 뺍니다.</li>
          <li>진입 전 10분 동안 쌓은 랭킹 스냅샷에서 반복 출현, 평균 순위, 최신 순위를 종합해 후보를 고릅니다. 일시적으로 튄 종목보다 관찰 구간 내내 상위권에 남은 종목을 우선합니다.</li>
