    ...
    <>
      ...
      <section className="panel section">
        ...
        <ul className="kr-rank-rule-list">
          ...
          <li>오전은 등락률 21% 이상, 점심은 되돌림 위험을 줄이기 위해 15% 이상 종목을 제외합니다. 우선주와 ETF·ETN·스팩·리츠·레버리지·인버스형 상품도 매수 대상에서 뺍니다.</li>
          ...
          <li>실주문 손실 청산이 발생한 날에는 남은 진입을 쉽니다. 실현손익 확인이 늦은 청산도 이익으로 넘겨짚지 않습니다. 손실 또는 손익 미확정 청산이 2회 연속이면 실행 상태는 유지한 채 새 진입만 잠그고, 이미 접수된 주문 확인과 보유 종목 청산은 계속합니다.</li>
