      ...
      <section className="panel section">
        <div className="panel-heading">
          <div>
            ...
            <p>오전 9시 10분(선택 시 11시 30분 점심)에 한국주식 등락률 상위 랭킹을 조회해, 오전 20% 미만·점심 16% 미만 후보 중 단기 흐름이 유지된 종목을 시장가로 매수하고 목표 수익·손절로 청산합니다. 서버가 30초 간격으로 평가합니다.</p>
          </div>
        </div>
        <ul className="kr-rank-rule-list">
          ...
          <li>당일 분봉으로 단기 흐름을 한 번 더 봅니다 — 시가 위, VWAP보다 0.1% 이상 위, VWAP 대비 과열 아님(오전 8%, 점심 6% 이내), 점심은 최근 VWAP 기준 과열 아님, 최근 3분 4%·8분 7% 이상 수직 급등 아님, 최근 완성봉 2개 VWAP 상회, 거래량 유지, 거래량 동반 장대 음봉 없음, 최근 고점 대비 1.2% 이상 밀리지 않음, 직전 고점의 99.5% 이상 유지. 상위 5개 안에서 통과 후보를 점수로 고르고, 모두 떨어지면 그 구간 매수는 건너뜁니다.</li>
