      ...
      <section className="panel section">
        <div className="panel-heading">
          <div>
            ...
            <p>오전 9시부터 10분간, 점심 진입을 켜면 11시 20분부터 10분간 한국주식 등락률 상위 랭킹을 반복 관찰한 뒤 9시 10분·11시 30분에 종합 후보를 고릅니다. 원본 랭킹 상위 10위 안에서 꾸준히 보인 종목만 두 번 확인하고, 조건이 맞지 않으면 그 구간은 쉬어 갑니다.</p>
          </div>
        </div>
        <ul className="kr-rank-rule-list">
          ...
          <li>진입 전 10분 동안 쌓은 랭킹 스냅샷에서 절반 이상 등장했고 진입 시점에도 원본 랭킹 상위 10위에 남은 종목만 봅니다. 첫 판단에서 모두 탈락하면 장중에 뒤늦게 새 후보를 쫓지 않고 해당 진입을 건너뜁니다.</li>
          ...
          <li>후보가 한 번 통과해도 바로 주문하지 않고 다음 평가에서 랭킹·분봉·가격을 다시 확인합니다. 매수는 현재가 근처(현재가 +0.4%) 지정가로 보내며, 신호가보다 0.7% 넘게 오르면 추격, 0.7% 넘게 내리면 모멘텀 무효로 보고 그 구간을 종료합니다.</li>
          ...
          <li>매수 직후 손절 기준에 닿아도 바로 팔지 않는 예외가 있습니다. 매수 후 10분 안, 손실이 10% 미만이면 하락의 성격을 봅니다 — 변동성 대비 칼낙, 상승봉 2배 이상의 거래량을 동반한 분출 매도, 완성봉 기준 추세 붕괴 중 하나라도 확인되면 곧바로 손절하고, 셋 다 아니면 초기 흔들기로 보고 지켜봅니다.</li>
