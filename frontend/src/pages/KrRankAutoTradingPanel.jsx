      ...
      <section className="panel section">
        <div className="panel-heading">
          <div>
            ...
            <p>오전 9시부터 10분간, 점심 진입을 켜면 11시 20분부터 10분간 한국주식 등락률 상위 랭킹을 반복 관찰한 뒤 9시 10분·11시 30분에 종합 후보를 고릅니다. 상승률이 오전 21%·점심 15% 미만이고 거래대금·단기 흐름이 충분한 종목만 현재가 근처 지정가로 매수합니다.</p>
          </div>
        </div>
        <ul className="kr-rank-rule-list">
          ...
          <li>진입 전 10분 동안 쌓은 랭킹 스냅샷에서 반복 출현, 평균 순위, 최신 순위를 종합해 후보를 고릅니다. 관찰이 충분한데 반복 출현 후보가 없으면 억지로 고르지 않고 해당 진입을 건너뜁니다.</li>
