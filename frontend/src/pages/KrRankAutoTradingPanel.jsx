      ...
      <section className="panel section">
        <div className="panel-heading">
          <div>
            ...
            <p>오전 9시부터 10분간, 점심 진입을 켜면 11시 20분부터 10분간 한국주식 등락률 상위 랭킹을 반복 관찰한 뒤 9시 10분·11시 30분에 종합 후보를 고릅니다. 상승률 21% 미만이고 거래대금·단기 흐름이 충분한 종목만 현재가 근처 지정가로 매수합니다.</p>
          </div>
        </div>
        <ul className="kr-rank-rule-list">
          ...
          <li>오전·점심 모두 등락률 21% 이상 종목을 제외합니다. 우선주와 ETF·ETN·스팩·리츠·레버리지·인버스형 상품도 매수 대상에서 뺍니다.</li>
          ...
          <li>매수 직후 손절 기준에 닿아도 바로 팔지 않는 예외가 있습니다. 매수 후 10분 안, 손실이 8% 미만이고 완성봉 기준 추세 붕괴가 확인되지 않으면 초기 흔들기로 보고 최대 6분까지 지켜봅니다.</li>
