      ...
      <section className="panel section">
        <div className="panel-heading">
          <div>
            ...
            <p>오전 9시 10분(선택 시 11시 30분 점심)에 한국주식 등락률 상위 랭킹을 조회해, 등락률 20% 미만 후보 중 단기 흐름이 유지된 첫 종목을 시장가로 매수하고 목표 수익·손절로 청산합니다. 서버가 30초 간격으로 평가합니다.</p>
          </div>
        </div>
        <ul className="kr-rank-rule-list">
          ...
          <li>오전·점심 모두 등락률 20% 이상 종목은 매수 대상에서 제외합니다 (상한가까지 여유 확보).</li>
