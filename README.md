...
자동매매 화면의 **미국장 상승률 랭킹 전략** 탭은 미국 정규장 동안 KIS 해외주식 상승률 랭킹을 1분마다 확인합니다. 보유 종목이 없으면 그 시점의 상승률 1위 종목을 사고, 보유 중이면 익절·손절·강제 청산 조건만 봅니다.
...
- 매수: 보유 종목이 없을 때 상승률 1위 종목을 고릅니다. 매수가능금액 전액을 쓰거나, 사용자가 정한 고정 USD 금액만 쓸 수 있습니다. 주문 수량은 1주 단위입니다.
- 매도 보류: 익절 기준에 닿았더라도 보유 종목이 여전히 상승률 1위라면 팔지 않고 계속 보유합니다. 팔았다가 곧바로 같은 종목을 다시 사는 왕복 주문을 줄이기 위한 규칙입니다.
- 매도: 보유 종목이 상승률 1위에서 밀렸고 익절 기준에 닿으면 전량 매도합니다. 손절 기준에 닿으면 전량 매도하고 그 미국 거래일에는 더 사지 않습니다.
- 강제 청산: 기본 KST 04:30 이후에는 익절·손절 여부와 관계없이 전량 매도를 시도하고, 그 미국 거래일의 신규 매수는 멈춥니다.
- 누적 목표: 시작 시점의 USD 매수가능금액 대비 사용자가 정한 누적 수익률에 도달하면 보유분을 정리하고 전략을 종료합니다.
