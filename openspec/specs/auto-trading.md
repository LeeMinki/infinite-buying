...
- `KR_RANK_LIVE_ENTRY_RETRY_ENABLED=false`이면 KR의 첫 live 판단이 후보 없음으로 끝난 뒤 5분 동안 실제 top 30 랭킹만 shadow로 저장하고, rolling 재탐색 결과로 신규 BUY를 만들지 않는다.
