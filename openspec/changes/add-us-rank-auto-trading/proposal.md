...
- 미국장은 가격제한폭이 없으므로 상승률 상한 필터 없이 첫 유효 랭킹 종목을 선택한다. 보유 종목이 계속 1위라면 익절 기준에 닿아도 팔지 않고, 누적 목표 수익률을 설정하면 시작 자본 대비 목표에 닿았을 때 전략을 종료한다. 주문은 1주 단위 정수 매수, 1분 간격 평가, 판단 로그·주문 이력·진입 기록 저장 패턴을 한국 랭킹과 맞춘다.
